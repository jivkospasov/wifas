(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GamingLaptopsComponent = /** @class */ (function () {
                function GamingLaptopsComponent(userService) {
                    this.userService = userService;
                    this.users = [];
                }
                GamingLaptopsComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.userService.getUsers2();
                    this.usersSub = this.userService.getUserUpdateListener().subscribe(function (users) {
                        _this.users = users;
                    });
                };
                return GamingLaptopsComponent;
            }());
            GamingLaptopsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RegisterComponent = /** @class */ (function () {
                ...
                RegisterComponent.prototype.generateForm = function () {
                    // tslint:disable-next-line: prefer-const
                    var nameFormControl = this.formBuilder.control(null, [
                    ...
                    // tslint:disable-next-line: prefer-const
                    var passwordFormControl = this.formBuilder.control(null, [
                        _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required,
                        _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].minLength(4),
                        _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].maxLength(15)
                    ]);
                    // tslint:disable-next-line: prefer-const
                    var emailFormControl = this.formBuilder.control(null, [
                        _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required,
                ...
                RegisterComponent.prototype.onRegisterSubmit = function (form) {
                    var _this = this;
                    this.userService.postUser(form.value).subscribe(function (res) { _this.showSuccessMessage = true; setTimeout(function () { return _this.showSuccessMessage = false; }, 4000); _this.resetForm(form); }, function (err) {
                        if (err.status === 422) {
                            _this.serverErrorMessage = err.error.join('<br/>');
                        }
                        else {
                            _this.serverErrorMessage = 'Something went wrong, contact the admin!';
                        }
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SignInComponent = /** @class */ (function () {
                ...
                SignInComponent.prototype.generateForm = function () {
                    // tslint:disable-next-line: prefer-const
                    var nameFormControl = this.formBuilder.control(null, [
                        _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required,
                        _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].minLength(4),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserService = /** @class */ (function () {
                ...
                UserService.prototype.postCard = function () {
                ...
                UserService.prototype.getUsers = function () {
                    ...
                    })).subscribe(function (transformedUsers) {
                        _this.users = transformedUsers;
                        _this.usersUpdated.next(_this.users.slice());
                    });
                };
                UserService.prototype.getUsers2 = function () {
                    var _this = this;
